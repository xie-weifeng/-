...
#define NRF24L01_TX_PACKET_WIDTH		13							//发送数据包宽度，范围：1~32字节
uint8_t NRF24L01_TxPacket[NRF24L01_TX_PACKET_WIDTH];				//发送数据包

/*接收部分*/
/* 接收端A（Pipe0） */
uint8_t NRF24L01_RxAddress_P0[5] = {0x11, 0x22, 0x33, 0x44, 0x01};

/* 接收端B（Pipe1） */
uint8_t NRF24L01_RxAddress_P1[5] = {0x11, 0x22, 0x33, 0x44, 0x02};


		//接收通道0地址，固定5字节
#define NRF24L01_RX_PACKET_WIDTH		13							//接收通道0数据包宽度，范围：1~32字节
...
void NRF24L01_Init(void)
{
	...
	NRF24L01_WriteReg(NRF24L01_EN_RXADDR, 0x03);	//使能接收通道，只开启接收通道0
...
uint8_t NRF24L01_SendTo(uint8_t *Addr)
{
	...
	NRF24L01_WriteRegs(NRF24L01_TX_ADDR, Addr, 5);
	NRF24L01_WriteRegs(NRF24L01_RX_ADDR_P0, Addr, 5);
